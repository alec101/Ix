...
${OBJECTDIR}/_ext/d2aad2f1/fileI3D.o: ../util/fileI3D.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d2aad2f1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DIX_USE_OPENGL -DIX_USE_VULKAN -DOSI_USE_OPENGL -DOSI_USE_VKO -I../.. -I../../Vulkan-Headers/include/vulkan -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2aad2f1/fileI3D.o ../util/fileI3D.cpp

${OBJECTDIR}/_ext/d2aad2f1/fileMAT.o: ../util/fileMAT.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d2aad2f1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DIX_USE_OPENGL -DIX_USE_VULKAN -DOSI_USE_OPENGL -DOSI_USE_VKO -I../.. -I../../Vulkan-Headers/include/vulkan -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2aad2f1/fileMAT.o ../util/fileMAT.cpp

${OBJECTDIR}/_ext/d2aad2f1/fileOBJ.o: ../util/fileOBJ.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d2aad2f1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DIX_USE_OPENGL -DIX_USE_VULKAN -DOSI_USE_OPENGL -DOSI_USE_VKO -I../.. -I../../Vulkan-Headers/include/vulkan -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2aad2f1/fileOBJ.o ../util/fileOBJ.cpp
